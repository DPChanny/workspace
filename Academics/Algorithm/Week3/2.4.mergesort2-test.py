...
test_cases_merge2 = [
    ...
    },
    {
        ...
        "mid": 4,
        "high": 9,
        "S": [5, 10, 15, 20, 25, 1, 2, 3, 4, 30],
        "expected": [1, 2, 3, 4, 5, 10, 15, 20, 25, 30],
        "desc": "비대칭 병합",
    },
    {
        "low": 0,
        "mid": 499999,
        "high": 999999,
        "S": list(range(0, 1000000, 2)) + list(range(1, 1000000, 2)),
...
test_cases_mergesort2 = [
    ...
    {
        "S": [1000, 500, 2000, 1500, 3000],
        "expected": [500, 1000, 1500, 2000, 3000],
        "desc": "큰 수 포함 리스트",
    },
    {
        "S": list(range(1000000, 0, -1)),
        "expected": list(range(1, 1000001)),
        "desc": "100만 개 역순 정렬",
    },
]
