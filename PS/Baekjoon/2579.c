  ...
  if (_count < 2) {
    if (_stairs_cal[_n][_count] == NULL) {
      ...
      if (_n == 0) {
        ...
        _stairs_cal[_n][_count] =
            get_max(_stairs, _stairs_cal, _n - 1, _count + 1) + _stairs[_n];
      } else {
        _stairs_cal[_n][_count] =
            max(get_max(_stairs, _stairs_cal, _n - 1, _count + 1),
                get_max(_stairs, _stairs_cal, _n - 2, 0)) +
            _stairs[_n];
      }
    }
  } else {
